...
clients_count = 5
epochs = 20
mitLoader = MITFederatedDataLoader(file_path)
model, history = fit_federated(clients_count=clients_count, federated_epochs=epochs,loader=mitLoader)
...
# %%
model.save(f"train_mit_fed_{clients_count}_{epochs}.h5")
